...
resource "aws_securityhub_standards_subscription" "cis" {
  ...
  standards_arn = "arn:aws-us-gov:securityhub:::ruleset/cis-aws-foundations-benchmark/v/1.2.0"
...
resource "aws_securityhub_standards_subscription" "aws_foundational" {
  ...
  standards_arn = "arn:aws-us-gov:securityhub:${data.aws_region.current.name}::standards/aws-foundational-security-best-practices/v/1.0.0"
...
resource "aws_securityhub_standards_subscription" "pci_dss" {
  ...
  standards_arn = "arn:aws-us-gov:securityhub:${data.aws_region.current.name}::standards/pci-dss/v/3.2.1"
